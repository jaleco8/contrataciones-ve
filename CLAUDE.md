# CLAUDE.md — Plan Maestro: Plataforma Abierta Anticorrupción Venezuela

> **Propósito de este documento**: Instrucciones completas y ordenadas para que Claude Code
...
## 6. Orden de ejecución para Claude Code
